<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Async="true" Inherits="WebformsIntegratedBE_Standalone.Account.Login" EnableEventValidation="false" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <%--Uncomment this line once you have account confirmation enabled for password reset functionality--%>
                    <%--<asp:HyperLink runat="server" ID="ForgotPasswordHyperLink" ViewStateMode="Disabled">Forgot your password?</asp:HyperLink>--%>
                </p>
            </section>
        </div>

        <%--If you want to allow social login (OAuth), then implement below--%>
        <div class="col-md-4">
